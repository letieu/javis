...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_HIMETRIC', 'LoadPictureConstants',
           'OLE_YPOS_HIMETRIC', 'OLE_COLOR', 'OLE_XPOS_HIMETRIC',
           'Color', 'FONTNAME', 'IFont', 'Checked', 'OLE_TRISTATE',
           'OLE_YSIZE_PIXELS', 'FONTITALIC', 'FONTBOLD', 'StdPicture',
           'FONTSTRIKETHROUGH', 'Gray', 'Unchecked', 'Font',
           'OLE_YPOS_PIXELS', 'OLE_OPTEXCLUSIVE', 'Monochrome',
           'OLE_YPOS_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XPOS_PIXELS', 'FontEvents', 'IPictureDisp',
           'OLE_XSIZE_HIMETRIC', 'IFontEventsDisp', 'OLE_HANDLE',
           'OLE_XSIZE_PIXELS', 'OLE_YSIZE_CONTAINER', 'StdFont',
           'Default', 'IPicture', 'OLE_XSIZE_CONTAINER', 'FONTSIZE',
           'OLE_CANCELBOOL', 'IFontDisp', 'Picture',
           'OLE_XPOS_CONTAINER', 'FONTUNDERSCORE', 'VgaColor']
